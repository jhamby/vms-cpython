...
if sys.platform != 'OpenVMS':
    raise ImportError('OpenVMS required')
...
class _OpenVMSSelectorEventLoop(selector_events.BaseSelectorEventLoop):
    """OpenVMS event loop.

    Adds signal handling and OpenVMS mailboxes support to SelectorEventLoop.
    """
