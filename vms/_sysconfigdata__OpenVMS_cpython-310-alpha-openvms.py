...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'alpha-openvms',
 'BYTESTR_DEPS': '\\',
 'CC': 'CC',
 'CCSHARED': '',
 'CFLAGS': '/NODEBUG/ARCH=EV56/OPTIMIZE=(TUNE=EV67)/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': '',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '/NODEBUG/ARCH=EV56/OPTIMIZE=(TUNE=EV67)/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CONFIGURE_CPPFLAGS': '/NODEBUG/ARCH=EV56/OPTIMIZE=(TUNE=EV67)/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': '',
 'CONFINCLUDEDIR': '/python$root/include',
 'CONFINCLUDEPY': '/python$root/include',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '',
 'COVERAGE_REPORT': '',
 'COVERAGE_REPORT_OPTIONS': '',
 'CPPFLAGS': '/NODEBUG/ARCH=EV56/OPTIMIZE=(TUNE=EV67)/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CXX': 'CXX',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'alpha-openvms',
 'INCLDIRSTOMAKE': '/python$root/include',
 'INCLUDEDIR': '/python$root/include',
 'INCLUDEPY': '/python$root/include',
 'INSTALL': '',
 'INSTALL_DATA': '',
 'INSTALL_PROGRAM': '',
 'INSTALL_SCRIPT': '',
 ...
 'LIBPL': '/sys$login/local/lib/python3.10/config-3.10-alpha-openvms',
