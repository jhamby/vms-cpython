...
PyInit__clidef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "CLI_M_DEBUG", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_DBGTRU", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_VERIFY", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_BATCH", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_INDIRECT", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_VFYINP", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_TRMVRBLV", 0x300UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_DBGEXCP", 0x10000UL);
    PyModule_AddIntConstant(m, "CLI_S_CLIDEF", 32);
    PyModule_AddIntConstant(m, "CLI_S_TRMVRBLV", 2);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_PARMREQ", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_ABSADR", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_EXPNAM", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_LASTVAL", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_DUMMY", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_PARMPRS", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_CONCATINP", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_MOREINP", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_PARMDEF", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_MOREVALS", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_KEYVALU", 0x2UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOWAIT", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOCLISYM", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOLOGNAM", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOKEYPAD", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOTIFY", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_NOCONTROL", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_TRUSTED", 0x40UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_AUTHPRIV", 0x80UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_SUBSYSTEM", 0x100UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_DETACHED", 0x200UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "CLI_M_ALLOCCUR", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_QDUSRV", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_QDEXPA", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_QUALTRU", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CLI_M_QUALEXP", 0x2UL);
