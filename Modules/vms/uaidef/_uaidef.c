...
PyInit__uaidef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISCTLY", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DEFCLI", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_LOCKPWD", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_RESTRICTED", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISACNT", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISWELCOM", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISMAIL", 0x40UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_NOMAIL", 0x80UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_GENPWD", 0x100UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_PWD_EXPIRED", 0x200UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_PWD2_EXPIRED", 0x400UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_AUDIT", 0x800UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISREPORT", 0x1000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISRECONNECT", 0x2000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_AUTOLOGIN", 0x4000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISFORCE_PWD_CHANGE", 0x8000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_CAPTIVE", 0x10000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISIMAGE", 0x20000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISPWDDIC", 0x40000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISPWDHIS", 0x80000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DEFCLSVAL", 0x100000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_EXTAUTH", 0x200000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_MIGRATEPWD", 0x400000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_VMSAUTH", 0x800000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_DISPWDSYNCH", 0x1000000UL);
    PyModule_AddUnsignedLongConstant(m, "UAI_M_PWDMIX", 0x2000000UL);
