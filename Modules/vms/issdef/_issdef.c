...
PyInit__issdef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "ISS_M_FLAG_PERMANENT", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_FLAG_SECAUDIT", 0x2UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ENABLED_PERSONA", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ENABLED_SUBSYSTEM", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ENABLED_IMAGE", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ENABLED_SYSTEM", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ENABLED_TEMPORARY", 0x10UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "ISS_M_IMP_FLAGS", 0x7FUL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ASSUME_NODEREF_OLD", 0x10000UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_ASSUME_NOREF_NEW", 0x20000UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_CREATE_DEFPRIV", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_CREATE_DEFCLASS", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_CREATE_AUTHPRIV", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "ISS_M_NOACCESS", 0x100000UL);
