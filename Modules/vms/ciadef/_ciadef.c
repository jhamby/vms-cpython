...
PyInit__ciadef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "CIA_M_IGNORE_RETURN", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_RESERVED_1", 0xFEUL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_SUSPECTS", 0x100UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_INTRUDERS", 0x200UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_SECONDARY_PASSWORD", 0x400UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_NOAUDIT", 0x800UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_REAL_USERNAME", 0x1000UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_SHOW_NODE", 0x2000UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_ITEMLIST", 0x4000UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_FILL_1", 0xFFFF8000UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "CIA_M_INTRUDER", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_SUSPECT", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_NETWORK", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_TERM_USER", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_TERMINAL", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_USERNAME", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "CIA_M_FILL_2", 0xFFFFFFC0UL);
