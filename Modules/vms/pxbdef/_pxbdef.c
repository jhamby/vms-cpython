...
PyInit__pxbdef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_CLONE", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_DELEGATE", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_FILL_3", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_FILL_4", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_FILL_5", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_FILL_6", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_FILL_7", 0x40UL);
    PyModule_AddUnsignedLongConstant(m, "PXBNT_M_DEBIT", 0x80UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_1", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_2", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_3", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_4", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_5", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_6", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_FILL_7", 0x40UL);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_DEBIT", 0x80UL);
    PyModule_AddIntConstant(m, "PXB_S_PXB_FLAGS", 4);
    PyModule_AddUnsignedLongConstant(m, "PXB_M_PRIMARY_EXTENSION", 0x1UL);
