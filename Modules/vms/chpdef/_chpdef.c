...
PyInit__chpdef(void) {
    ...
    PyModule_AddIntConstant(m, "CHP_M_SYSPRV", 0x1L);
    PyModule_AddIntConstant(m, "CHP_M_BYPASS", 0x2L);
    PyModule_AddIntConstant(m, "CHP_M_UPGRADE", 0x4L);
    PyModule_AddIntConstant(m, "CHP_M_DOWNGRADE", 0x8L);
    PyModule_AddIntConstant(m, "CHP_M_GRPPRV", 0x10L);
    PyModule_AddIntConstant(m, "CHP_M_READALL", 0x20L);
    PyModule_AddIntConstant(m, "CHP_M_OPER", 0x40L);
    PyModule_AddIntConstant(m, "CHP_M_GRPNAM", 0x80L);
    PyModule_AddIntConstant(m, "CHP_M_SYSNAM", 0x100L);
    PyModule_AddIntConstant(m, "CHP_M_GROUP", 0x200L);
    PyModule_AddIntConstant(m, "CHP_M_WORLD", 0x400L);
    PyModule_AddIntConstant(m, "CHP_M_PRMCEB", 0x800L);
    PyModule_AddIntConstant(m, "CHP_K_NUMBER_OF_PRIVS", 12);
    PyModule_AddIntConstant(m, "CHP_S_PRIVS_USED_BITS", 2);
    PyModule_AddIntConstant(m, "CHP_M_OBSERVE", 0x1L);
    PyModule_AddIntConstant(m, "CHP_M_ALTER", 0x2L);
    PyModule_AddIntConstant(m, "CHP_M_READ", 0x1L);
    PyModule_AddIntConstant(m, "CHP_M_WRITE", 0x2L);
    PyModule_AddIntConstant(m, "CHP_M_USEREADALL", 0x4L);
    PyModule_AddIntConstant(m, "CHP_M_AUDIT", 0x8L);
    PyModule_AddIntConstant(m, "CHP_M_NOFAILAUD", 0x10L);
    PyModule_AddIntConstant(m, "CHP_M_NOSUCCAUD", 0x20L);
    PyModule_AddIntConstant(m, "CHP_M_DELETE", 0x40L);
    PyModule_AddIntConstant(m, "CHP_M_MANDATORY", 0x80L);
    PyModule_AddIntConstant(m, "CHP_M_FLUSH", 0x100L);
    PyModule_AddIntConstant(m, "CHP_M_CREATE", 0x200L);
    PyModule_AddIntConstant(m, "CHP_M_INTERNAL", 0x400L);
    PyModule_AddIntConstant(m, "CHP_M_SERVER", 0x800L);
    PyModule_AddIntConstant(m, "CHP_S_FLAG_BITS", 2);
    PyModule_AddIntConstant(m, "CHP_M_NOACCESS", 0x1L);
    PyModule_AddIntConstant(m, "CHP_M_REMDUPID", 0x2L);
    PyModule_AddIntConstant(m, "CHP_M_INCSYSID", 0x4L);
    PyModule_AddIntConstant(m, "CHP_M_INCIMGID", 0x8L);
    PyModule_AddIntConstant(m, "CHP_M_DEFPRIV", 0x10L);
    PyModule_AddIntConstant(m, "CHP_M_DEFCLASS", 0x20L);
