...
PyInit__prxdef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "PRX_M_IGNORE_RETURN", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_BYPASS_EXPAND", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_RESERVE_1", 0xFCUL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_DEFAULT", 0x100UL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_EXACT", 0x200UL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_DELETE_ALLOWED", 0x400UL);
    PyModule_AddUnsignedLongConstant(m, "PRX_M_FILL_1", 0xFFFFF800UL);
