...
PyInit__pscandef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_THREAD", 0x1UL);
    PyModule_AddIntConstant(m, "PSCAN_S_PSCANCTLDEF", 4);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_OR", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_BIT_ALL", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_BIT_ANY", 0x4UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_GEQ", 0x8UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_GTR", 0x10UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_LEQ", 0x20UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_LSS", 0x40UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_PREFIX_MATCH", 0x80UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_WILDCARD", 0x100UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_CASE_BLIND", 0x200UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_EQL", 0x400UL);
    PyModule_AddUnsignedLongConstant(m, "PSCAN_M_NEQ", 0x800UL);
