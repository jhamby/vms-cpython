...
PyInit__acrdef(void) {
    ...
    PyModule_AddUnsignedLongConstant(m, "ACR_M_PACKET", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_TYPE", 0xFEUL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_SUBTYPE", 0xF00UL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_VERSION", 0x7000UL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_CUSTOMER", 0x8000UL);
    ...
    PyModule_AddUnsignedLongConstant(m, "ACR_M_FULLNAME", 0x1UL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_UIDGID", 0x2UL);
    PyModule_AddUnsignedLongConstant(m, "ACR_M_FILL_1", 0xFCUL);
