...
PyInit__fpdef(void) {
    ...
    PyModule_AddIntConstant(m, "HWINT_M_CPU_SELECTED", 0x1L);
    PyModule_AddIntConstant(m, "HWINT_M_CPU_NOT_IN_RAD", 0x2L);
    PyModule_AddIntConstant(m, "HWINT_M_PRIMARY", 0x4L);
    PyModule_AddIntConstant(m, "HWINT_S_HWINT_FLAGS", 8);
    PyModule_AddIntConstant(m, "FPRAD_S_FPRAD", 16);
    PyModule_AddIntConstant(m, "FP_M_SPL_HOLD", 0x1L);
